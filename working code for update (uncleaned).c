...
int updateProcess(int ID){
	...
	if ((isdigit(year))) {
		...
		//it(expiration, "%d-%d-%d", year, month, day);
		//expiration = strcat(year, "-"); 
		//expiration = strcat(expiration, "month");
		//expiration = strcat(expiration, "-");
		//expiration = strcat(expiration, "year");
	}
	
	//expiration = ("%d-%d-%d", year, month, day);	
	sprintf(newExpiDate, "%d-%d-%d", year, month, day);
	//printf("%d-%d-%d\n", year, month, day);
	printf("%s\n", &newExpiDate);
